/**
 * Minimal Monaco bundle: editor core + Lua syntax only.
 *
 * Avoids `import * from "monaco-editor"` (editor.main.js), which pulls in every
 * basic language and the JSON/CSS/HTML/TypeScript language services + workers.
 *
 * This is basically node_modules/monaco-editor/esm/vs/editor/editor.main.js,
